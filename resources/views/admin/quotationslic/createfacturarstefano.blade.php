    ...
    <div class="row justify-content-center" >
            ...
            <div class="card" style="width: 70rem;" >
                ...
                <div class="card-body" >
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <label for="code_comercial">CI/Rif Cliente:</label>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-2">
                                <label for="code_comercial">N° de Control/Serie:</label>
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <label for="code_comercial">Total Factura:</label>
                            </div>
                            <div class="col-sm-4">
                                <input id="total_factura" type="text" class="form-control @error('total_factura') is-invalid @enderror" name="total_factura" value="{{ number_format($total , 2, ',', '.')  }}" readonly required autocomplete="total_factura">
                            ...
                            <div class="col-md-3">
                                <input id="base_imponible" type="text" class="form-control @error('base_imponible') is-invalid @enderror" name="base_imponible" value="{{ number_format($total , 2, ',', '.') }}" readonly required autocomplete="base_imponible">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input id="porc_retencion_iva" type="text" class="form-control @error('porc_retencion_iva') is-invalid @enderror" value="" readonly name="porc_retencion_iva" autocomplete="porc_retencion_iva">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="iva_amount" type="text" class="form-control @error('iva_amount') is-invalid @enderror" name="iva_amount" value="{{$total_iva}}" readonly required autocomplete="iva_amount">
                            ...
                            <div class="col-md-3">
                                <input id="iva_retencion" type="text" class="form-control @error('iva_retencion') is-invalid @enderror" name="iva_retencion" value="{{$total_iva_pcb}}" readonly required autocomplete="iva_retencion">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="grand_total" type="text" class="form-control @error('grand_total') is-invalid @enderror" name="" value="{{$total_venta}}"  readonly required autocomplete="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="total_pay" type="text" class="form-control @error('total_pay') is-invalid @enderror" name="total_pay" value="{{$total_venta}}"  readonly  required autocomplete="total_pay">
            ...
            <form method="POST" action="{{ route('quotations.storefactura') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <input type="hidden" id="iva_retencion" name="iva_retencion"   value="{{$total_iva_pcb}}" readonly>
                        <!--Total de la factura sin restarle nada que se va a realizar-->
                        <input type="hidden" id="grandtotal_form" name="grandtotal_form"  readonly>

                        <!--Total del pago que se va a realizar-->
                        <input type="hidden" id="total_pay_venta" name="total_pay_venta"  value="{{$total_venta}}"  >
