...
<div class="container" >
    <div class="row justify-content-center" >
            ...
            <div class="card" style="width: 70rem;" >
                ...
                <div class="card-body" >
                        ...
                        <div class="form-group row">
                            ...
                            <label for="serie" class="col-md-2 col-form-label text-md-right">N° Ctrl/Serie: 00-</label>
                            <div class="col-md-3">

                                @if (isset($quotation->serie))
                                <input id="serie" type="text" class="form-control @error('serie') is-invalid @enderror" name="serie" value="{{ $quotation->serie}}" autocomplete="serien">
                                @else
                                <input style="color:red" id="serie" type="text" class="form-control @error('serie') is-invalid @enderror" name="serie" value="{{ $newcontrolf }}" autocomplete="serie">     
                                @endif
                                @error('serie')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        @if (isset($is_after) && ($is_after == true))
                            <div class="form-group row" id="formenviarcredito">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('quotationslic.create',[$quotation->id,$coin]) }}" id="btnfacturar" name="btnfacturar" class="btn btn-danger" title="facturar">Volver</a>  
                                </div>
                            </div>
                        @endif
            ...
            <form method="POST" action="{{ route('quotationslic.storefactura') }}" enctype="multipart/form-data">
                @csrf   
...
@section('consulta')
    <script>
        ...
        $("#coin").on('change',function(){
            coin = $(this).val();
            window.location = "{{route('quotationslic.createfacturar', [$quotation->id,''])}}"+"/"+coin;
        });
