...
<div class="container-fluid">
    <div class="row py-lg-2">
        ...
        <div class="col-sm-4" style="text-align: right;">
            <a href="{{ route('directchargeorders.create')}}" class="btn btn-info" title="Transferencia">Crear Orden de Cobro</a>
        </div>
    </div>
</div>
<br>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center font-weight-bold h3">Lista de Orden de Cobro (Movimientos Contables.)</div>
                                ...
                                <tbody>
                                    ...
                                    @else
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('directchargeorders.delete',$var->id_header_voucher ?? null) }}" class="delete" title="Eliminar"><i class="fa fa-trash text-danger"></i></a>  
                                        </td>  
...
@section('javascript')
    ...
    function pdf(id_header_voucher) {
            var nuevaVentana= window.open("{{ route('directchargeorders.directchargeorderPaymentPdfDetail','')}}"+"/"+id_header_voucher,"ventana","left=800,top=800,height=800,width=1000,scrollbar=si,location=no ,resizable=si,menubar=no");   
        }
    </script> 
@endsection