                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('debitnotes.store') }}" enctype="multipart/form-data">
                        ...
                        <div id="clientform" class="form-group row">
                            ...
                            <div class="form-group col-md-1">
                                <a href="{{ route('debitnotes.selectclient') }}" title="Seleccionar Cliente"><i class="fa fa-eye"></i></a>  
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <a href="{{ route('debitnotes') }}" id="btnvolver" name="btnvolver" class="btn btn-danger" title="volver">Volver</a>  
                            </div>
                        </div>
                        </form>      
