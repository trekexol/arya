...
<div class="container" >
    <div class="row justify-content-center" >
        <div class="col-md-12" >
            <div class="card">
                <div class="card-header" ><h3>Registro de Nota de Dédito</h3></div>
                ...
                <div class="card-body" >
                        ...
                        <form id="formSendProduct" method="POST" action="{{ route('debitnotes.storeproduct') }}" enctype="multipart/form-data" onsubmit="return validacion()">
                            @csrf
                                ...
                                <div class="form-row col-md-12">
                                    ...
                                    <div class="form-group col-md-1">
                                        ...
                                        <a href="" title="Buscar Producto Por Codigo" onclick="searchCode()"><i class="fa fa-search"></i></a>  
                                            ...
                                            <a href="{{ route('debitnotes.selectproduct',[$creditnote->id,$coin,'productos']) }}" title="Productos"><i class="fa fa-eye"></i></a>  
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <td style="text-align: right">
                                                        <a href="{{ route('debitnotes.productedit',[$var->credit_note_details_id,$coin]) }}" title="Editar"><i class="fa fa-edit"></i></a>  
...
<div class="modal modal-danger fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="Delete" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('debitnotes.deleteProduct') }}" method="post">
                @csrf
                @method('DELETE')
...
@section('validacion')
    <script>
     $('#dataTable').dataTable( {
        ...
        $("#coin").on('change',function(){
            coin = $(this).val();
            window.location = "{{route('debitnotes.create', [$creditnote->id,'',''])}}"+"/"+coin+"/"+"{{$inventory->id ?? ''}}";
        });
    ...
    function refreshrate() {
        ...
        window.location = "{{ route('debitnotes.refreshrate',[$creditnote->id,$coin,'']) }}"+"/"+rate;
    ...
    function searchCode2(callback){
            ...
            if(reference_id != ""){
                ...
                url:"{{ route('debitnotes.listinventory') }}" + '/' + reference_id,
                beforSend:()=>{
                ...
                success:(response)=>{
                    ...
                    if(response.length > 0){
                        response.forEach((item, index, object)=>{
                           ...
                           window.location = "{{route('debitnotes.createproduct', [$creditnote->id,$coin,''])}}"+"/"+id;
                           
                        });
                    }else{
                        window.location = "{{route('debitnotes.create', [$creditnote->id,$coin,''])}}";
