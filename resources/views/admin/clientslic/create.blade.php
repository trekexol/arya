                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('clientslic.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control" id="id_vendor" name="id_vendor">
                                ...
                                @foreach($vendors as $vendor)
                                    <option value="{{ $vendor->id ?? null}}">{{ $vendor->name ?? ''}}</option>
                                @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') ?? 'Caracas' }}" required autocomplete="city">
                                @error('city')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input id="phone1" type="text" class="form-control @error('phone1') is-invalid @enderror" name="phone1" value="{{ old('phone1') ?? 0000-0000000}}" placeholder="0000 000-0000"  autocomplete="phone1">
                            ...
                            <div class="col-sm-4">
                                <input id="phone2" type="text" class="form-control @error('phone2') is-invalid @enderror" name="phone2" value="{{ old('phone2') ?? 0000-0000000}}" placeholder="0000 000-0000"  autocomplete="phone2">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="email" class="col-md-2 col-form-label text-md-right">Moneda Bs.</label>
                                <div class="form-check">
                               
        
                                <input class="form-check-input position-static" type="checkbox" id="has_mon" name="has_mon" onclick="bsfijo();" value="option1" aria-label="...">
                                <input id="moneda" type="hidden" name="moneda" value="0">
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('clientslic') }}" name="danger" type="button" class="btn btn-danger">Cancelar</a>
                            </div>
                        </div>
                    </form>
                </div>
...
@section('validacion')
    ...
    function bsfijo()
    {
        if (document.getElementById('has_mon').checked) {
            $("#moneda").val(1);
