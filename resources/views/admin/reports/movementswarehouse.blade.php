...
<body>
  ...
  <h4 style="color: black; text-align: center">MOVIMIENTO DE ALMACÉN</h4>
 <?php 
  ...
  <tr>
    ...
    ?>
        <tr>
          ...
          <td style="text-align: center; font-weight: normal;">{{ $inventory->almacen_origen}}</td>
          <td style="text-align: center; font-weight: normal;">{{ $inventory->almacen_destino}}</td>
