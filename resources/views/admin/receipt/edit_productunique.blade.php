        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
            <form  method="POST"   action="{{ route('receipt.productupdateunique',$quotation_product->id) }}" enctype="multipart/form-data" onsubmit="return validacion()">
                @method('PATCH')
                @csrf()
                        ...
                        <div class="col-md-3">
                            <input id="rate" type="text" readonly class="form-control @error('rate') is-invalid @enderror" name="rate" value="{{ number_format($quotation_product->rate, 2, ',', '.')}}"  required autocomplete="rate">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-md-2">
                                        <a href="{{ route('receipt.createunique',[$quotation_product->id_quotation,$coin]) }}" id="btnfacturar" name="btnfacturar" class="btn btn-danger" title="facturar">Volver</a>  
                                    </div>
                                </div>
