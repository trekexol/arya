...
<body>
  ...
  <br>
  <h4 style="color: black; text-align: center">RESUMEN DE RELACIÓN DE GASTOS</h4>
...
<table style="width: 100%;">
  <tr>
    ...
    <th style="text-align: center; width:22%;">Condominio</th>
    <th style="text-align: center;">CI/RIF</th>
  ...
  @foreach ($quotations as $quotation)
    ...
    <tr>
      ...
      <th style="text-align: center; font-weight: normal;">{{ $quotation->type_code ?? ''}}{{ $quotation->cedula_rif ?? ''}}</th>
