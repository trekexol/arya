                ...
                <div class="card-body" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <a onclick="pdf();" id="btnimprimir" name="btnimprimir" class="btn btn-info" title="imprimir">Ver Recibo de Condominio</a>  
                            </div>
                            
                            <div class="col-sm-3  dropdown mb-4" style="display:none;">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('receipt.reversarQuotation') }}" method="post">
                ...
                @method('DELETE')
                <div class="modal-body">
                    <h5 class="text-center">Seguro quiere reversar el recibo?</h5>
