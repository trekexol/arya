    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('vendorslic.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('vendorslic') }}" id="btnfacturar" name="btnfacturar" class="btn btn-danger" title="facturar">Volver</a>  
                            </div>
                        </div>
                    </form>
                </div>
