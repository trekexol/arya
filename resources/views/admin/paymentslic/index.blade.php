...
<div class="container-fluid">
    ...
    <div class="row py-lg-2">
        ...
        <div class="col-md-2">
            <a href="{{ route('invoiceslic')}}" class="btn btn-info btn-icon-split">
        ...
        <div class="col-md-2 offset-sm-1">
            <a href="{{ route('report_paymentslic.index','todos')}}" class="btn btn-info btn-icon-split">
                <span class="icon text-white-50">
                    ...
                    @foreach ($payment_quotations as $payment_quotation)
                        <tr>
                            ...
                            <td class="text-center font-weight-bold">
                                <a href="{{ route('paymentslic.movement',$payment_quotation->id_quotation ?? -1) }}" title="Ver Movimiento" class="font-weight-bold text-dark">{{ $payment_quotation->id }}</a>
                            </td>
...
<div class="modal modal-danger fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="Delete" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('paymentslic.deleteAllPayments') }}" method="post">
                @csrf
                @method('DELETE')
...
@section('javascript')
    <script>
        ...
        function pdf(id_payment) {
            var nuevaVentana= window.open("{{ route('paymentslic.pdf',['',''])}}"+"/"+id_payment+"/"+'bolivares',"ventana","left=800,top=800,height=800,width=1000,scrollbar=si,location=no ,resizable=si,menubar=no");   
        }
