...
<div class="form-row">
    <div class="col-3">
        <small>
            <select id="tipopago{{ $numero }}"  name="tipopago[]" class="form-control form-control-sm tipopago">
    ...
    <div class="col-3 referencia{{ $numero }}">
        <small>
    ...
    <div class="col-3">
        <small>
            <input type="text" name="monto[]" class="form-control form-control-sm" value="{{ $monto }}">
        </small>
    </div>
</div>
<br>
...
var numero = "<?php echo $numero ?>";
    ...
    $("#tipopago"+numero).change(function () {
        $("#tipopago"+numero+" option:selected").each(function () {
            valor = $(this).val();
