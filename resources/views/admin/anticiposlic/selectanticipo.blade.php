...
<div class="container-fluid">
    ...
    <div class="row py-lg-2">
        ...
        <div class="col-md-3">
            <a href="{{ route('quotationslic.createfacturar',[$id_quotation,$coin]) }}" id="btnfacturar" name="btnfacturar" class="btn btn-info" title="facturar">Volver a la Factura</a>  
        </div>
    ...
    function changestatus(anticipo){
        var verify = document.getElementById("flexCheckChecked"+anticipo).checked;
            ...
            $.ajax({
                ...
                url:"{{ route('anticiposlic.changestatus',['','']) }}" + '/' + anticipo+'/' + verify,
                beforSend:()=>{
