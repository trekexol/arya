...
<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link active font-weight-bold" style="color: black;" id="profile-tab"  href="{{ route('anticiposlic.index_provider') }}" role="tab" aria-controls="profile" aria-selected="false">Anticipo a Proveedores</a>
    </li>
</ul>
<!-- container-fluid -->
    ...
    <div class="row py-lg-2">
        ...
        @if ($control != 'index')
            <div class="col-md-2 offset-md-3">
                <a href="{{ route('anticiposlic.index_provider')}}" class="btn btn-info btn-icon-split">
        ...
        @else
            <div class="col-md-4 offset-md-1">
                <a href="{{ route('anticiposlic.historic_provider')}}" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
        ...
        <div class="col-md-3">
            <a href="{{ route('anticiposlic.create_provider')}}" class="btn btn-primary" role="button" aria-pressed="true">Registrar un Anticipo</a>
...
<div class="modal modal-danger fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="Delete" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('anticiposlic.delete_provider') }}" method="post">
                @csrf
                @method('DELETE')
