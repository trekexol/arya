    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('anticiposlic.store_provider') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group col-md-1">
                                <a href="{{ route('anticiposlic.selectprovider') }}" title="Seleccionar Proveedor"><i class="fa fa-eye"></i></a>  
                            </div>
                        </div>
                    ...
                    <br>
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('anticiposlic') }}" id="btnfacturar" name="btnfacturar" class="btn btn-danger" title="facturar">Volver</a>                                 
                            </div>
                        </div>
                    </form>
                </div>
