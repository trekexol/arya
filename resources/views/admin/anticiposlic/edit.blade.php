...
@if ($errors->any())
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form  method="POST"   action="{{ route('anticiposlic.update',$anticipo->id) }}" enctype="multipart/form-data" >
                @method('PATCH')
                @csrf()
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group col-md-1">
                                        @if (isset($anticipo->clients['name']))
                                            <a href="{{ route('anticiposlic.selectclient',$anticipo->id) }}" title="Seleccionar Cliente"><i class="fa fa-eye"></i></a>                                    
                                        @else
                                            <a href="{{ route('anticiposlic.selectprovider',$anticipo->id) }}" title="Seleccionar Cliente"><i class="fa fa-eye"></i></a>
                                        @endif
                                      </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        @if (isset($anticipo->clients['id']))
                                            <a href="{{ route('anticiposlic') }}" name="danger" type="button" class="btn btn-danger btn-block">Cancelar</a>                                 
                                        @else
                                            <a href="{{ route('anticiposlic.index_provider') }}" name="danger" type="button" class="btn btn-danger btn-block">Cancelar</a>                                 
                                        @endif
                                    </div>
                                </div>
