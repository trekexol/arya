...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center font-weight-bold h3">Registro de Condominios</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('condominiums.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('condominiums') }}" name="danger" type="button" class="btn btn-danger">Cancelar</a>
                            </div>
                        </div>
                    </form>
                </div>
