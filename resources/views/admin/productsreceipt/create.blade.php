    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('productsreceipt.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row" style="display:none;">
                            ...
                            <select id="segment"  name="segment" class="form-control" required>
                                <option value="1">Seleccione un Segmento</option>
                            ...
                            <div class="col-md-4">
                                <select  id="subsegment"  name="Subsegment" class="form-control" >
                                    <option value="1">Selecciona un Sub Segmento</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control" id="unit_of_measure_id" name="unit_of_measure_id">
                                    ...
                                    <option value="25">Unidad</option>
                             
                              
                            </select>
                            </div>
                        </div>
                            <label for="code_comercial" class="col-md-2 col-form-label text-md-right">ID Producto</label>
                            ...
                            <div class="col-md-4">
                            (Código único o ID para agilizar la busqueda)
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('productsreceipt') }}" id="btnfacturar" name="btnfacturar" class="btn btn-danger" title="facturar">Volver</a>  
                            </div>
                        </div>
                    </form>
                </div>
