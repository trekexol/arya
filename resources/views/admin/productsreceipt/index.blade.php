...
<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
      <a class="nav-link active font-weight-bold" style="color: black;" id="home-tab"  href="{{ route('productsreceipt') }}" role="tab" aria-controls="home" aria-selected="true">Productos/Servicios</a>
    </li>
    <li class="nav-item" role="presentation">
...
<div class="container-fluid">
    ...
    <div class="row py-lg-2">
      ...
      <div class="col-sm-3">
        <a href="{{ route('productsreceipt.create')}}" class="btn btn-primary float-md-right" role="button" aria-pressed="true">Registrar un Producto </a>
      </div>
    </div>
  </div>
  <!-- /.container-fluid -->
                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('productsreceipt.edit',$product->id) }}"  title="Editar"><i class="fa fa-edit"></i></a>
...
<div class="modal modal-danger fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="Delete" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <form action="{{ route('productsreceipt.delete') }}" method="post">
              @csrf
              @method('DELETE')
