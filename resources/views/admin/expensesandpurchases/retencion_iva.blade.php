...
<table>
  ...
  <tr>
    ...
    <td style="font-size: x-small;">{{ $periodo_pago.''.$mes_pago.''.str_pad($expense->number_iva, 8, "0", STR_PAD_LEFT) ?? 'Vista Previa'}}</td>
  </tr>
...
<table>
  ...
  <tr>
    ...
    <td style="font-size: x-small;">{{ date_format(date_create($expense->dateregistro ?? $expense->date_payment ?? $expense->date ?? '00-00-0000'),"d-m-Y") }}</td>
  </tr>
