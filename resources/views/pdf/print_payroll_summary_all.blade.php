...
?>
    ...
    <tr>
      ...
      <td style="text-align: right;">{{ number_format($employee->asignacion, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($employee->bono_medico, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($employee->bono_alim, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($employee->bono_transporte, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($employee->deduccion_sso, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($employee->deduccion_faov, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($employee->deduccion_pie, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($total_sso_patronal, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($total_faov_patronal, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($total_pie_patronal, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($otras_deducciones, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($monto_neto, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($deducciones, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($asignaciones, 2, ',', '.').' Bs'}}</td>
      <td style="text-align: right;">{{ number_format($total_general, 2, ',', '.').' Bs'}}</td>
    </tr>
...
@endforeach
  ...
  <tfoot>
    <tr>
      ...
      <th style="text-align: right;">{{ number_format($total_asignacion_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_bono_medico_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_bono_alim_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_bono_transporte_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_deduccion_sso_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_deduccion_faov_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_deduccion_pie_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_sso_patronal_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_faov_patronal_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_pie_patronal_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_otras_deducciones_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_monto_neto_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_deducciones_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_asignaciones_global, 2, ',', '.').' Bs'}}</th>
      <th style="text-align: right;">{{ number_format($total_total_general_global, 2, ',', '.').' Bs'}}</th>
    </tr>
  </tfoot>
