    ...
    'connections' => [
        ...
        'logisticrefres' => [
            ...
            'north_seniat' => [
                ...
                'port' => env('NORTHSENIAT_PORT', '3306'),
                'database' => env('NORTHSENIAT_DATABASE', 'forge'),
                'username' => env('NORTHSENIAT_USERNAME', 'forge'),
                'password' => env('NORTHSENIAT_PASSWORD', ''),
                'unix_socket' => env('NORTHSENIAT_SOCKET', ''),
                'charset' => 'utf8',
                'collation' => 'utf8_unicode_ci',
                'prefix' => '',
                'prefix_indexes' => true,
            ...
            'respaldodonap' => [
                'driver' => 'mysql',
                'url' => env('DATABASE_URL'),
                'host' => env('RESPALDODONAP_HOST', '127.0.0.1'),
                'port' => env('RESPALDODONAP_PORT', '3306'),
                'database' => env('RESPALDODONAP_DATABASE', 'forge'),
                'username' => env('RESPALDODONAP_USERNAME', 'forge'),
                'password' => env('RESPALDODONAP_PASSWORD', ''),
                'unix_socket' => env('RESPALDODONAP_SOCKET', ''),
                'charset' => 'utf8',
                'collation' => 'utf8_unicode_ci',
                'prefix' => '',
                'prefix_indexes' => true,
