    ...
    */
    ...
    'connections' => [
        ...
        'frigosur' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('FRIGOSUR_HOST', '127.0.0.1'),
            'port' => env('FRIGOSUR_PORT', '3306'),
            'database' => env('FRIGOSUR_DATABASE', 'forge'),
            'username' => env('FRIGOSUR_USERNAME', 'forge'),
            'password' => env('FRIGOSUR_PASSWORD', ''),
            'unix_socket' => env('FRIGOSUR_SOCKET', ''),
            'charset' => 'utf8mb4',
        ...
        'logisticrefres' => [
            ...
            'vbonpland' => [
                ...
                'unix_socket' => env('VBONPLAND_SOCKET', ''),
                'charset' => 'utf8',
                'collation' => 'utf8_unicode_ci',
                'prefix' => '',
                'prefix_indexes' => true,
            ...
            'visionvm' => [
                'driver' => 'mysql',
                'url' => env('DATABASE_URL'),
                'host' => env('VISIONVM_HOST', '127.0.0.1'),
                'port' => env('VISIONVM_PORT', '3306'),
                'database' => env('VISIONVM_DATABASE', 'forge'),
                'username' => env('VISIONVM_USERNAME', 'forge'),
                'password' => env('VISIONVM_PASSWORD', ''),
                'unix_socket' => env('VISIONVM_SOCKET', ''),
                'charset' => 'utf8',
                'collation' => 'utf8_unicode_ci',
                'prefix' => '',
                'prefix_indexes' => true,
            ...
            'grupocci' => [
                'driver' => 'mysql',
                'url' => env('DATABASE_URL'),
                'host' => env('GRUPOCCI_HOST', '127.0.0.1'),
                'port' => env('GRUPOCCI_PORT', '3306'),
                'database' => env('GRUPOCCI_DATABASE', 'forge'),
                'username' => env('GRUPOCCI_USERNAME', 'forge'),
                'password' => env('GRUPOCCI_PASSWORD', ''),
                'unix_socket' => env('GRUPOCCI_SOCKET', ''),
                'charset' => 'utf8',
                'collation' => 'utf8_unicode_ci',
                'prefix' => '',
                'prefix_indexes' => true,
            ...
            'famivar' => [
                'driver' => 'mysql',
                'url' => env('DATABASE_URL'),
                'host' => env('FAMIVAR_HOST', '127.0.0.1'),
                'port' => env('FAMIVAR_PORT', '3306'),
                'database' => env('FAMIVAR_DATABASE', 'forge'),
                'username' => env('FAMIVAR_USERNAME', 'forge'),
                'password' => env('FAMIVAR_PASSWORD', ''),
                'unix_socket' => env('FAMIVAR_SOCKET', ''),
                'charset' => 'utf8',
                'collation' => 'utf8_unicode_ci',
                'prefix' => '',
                'prefix_indexes' => true,
