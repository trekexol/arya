...
use App\Exports\Reports\PaymentExpenseExportFromView;
...
class PaymentExpenseExportController extends Controller
{
    public function exportExcel(Request $request) 
    {
        ...
        $export = new PaymentExpenseExportFromView($request);
