...
class ReportDeliveryFacController extends Controller
{
    ...
    public function index_accounts_receivable_fac_det($typepersone = 'todo',$id_client_or_vendor = 'todo',$date_end = 'todo',$date_frist = 'todo',$typeinvoice = 'todo')
    {        
        ...
        if($userAccess->validate_user_access($this->modulo)){
            ...
            return view('admin.reports.index_accounts_receivable_fac_det',compact('typepersone','client','vendor','date_end','date_frist','typeinvoice','id_client_or_vendor'));
    ...
    public function store_accounts_receivable_fac_det(Request $request)
    {
        ...
        return view('admin.reports.index_accounts_receivable_fac_det',compact('coin','typeinvoice','date_end','client','vendor','typepersone','date_frist','id_client_or_vendor'));
    }
    ...
    function accounts_receivable_fac_det_pdf($coin,$date_end,$typeinvoice,$typepersone = 'todo',$id_client_or_vendor = 'todo',$date_frist = '0001-01-01')
    {
       // dd('Moneda: '.$coin.' Hasta: '.$date_end.' ID-Cliente-Vend: '.$id_client_or_vendor.' Tipo: '.$typeinvoice.' Persona: '.$typepersone.' Fecha frist ');
        ...
        $pdf = $pdf->loadView('admin.reports.accounts_receivable_fac_det',compact('coin','quotations','date_end','date_frist','typepersone','id_client_or_vendor'))->setPaper('a4', 'landscape');
...
//nota detalle -------------------------------------
    ...
    public function select_client_fac_det()
    {

        $clients    = Client::on(Auth::user()->database_name)->get();
        $typepersone = 'cliente';
        return view('admin.reports.selectclient_fac_det',compact('typepersone','clients'));
    }

    
    public function select_vendor_fac_det()
    {
        $vendors    = Vendor::on(Auth::user()->database_name)->get();
        $typepersone = 'vendor';
        return view('admin.reports.selectvendor_fac_det',compact('typepersone','vendors'));
    }
