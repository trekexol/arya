...
class CondominiumsController extends Controller
{
   ...
   public function create()
   {
       ...
       return view('admin.condominiums.create',compact('vendors','branches'));
   }
   ...
   {
        $var = Condominiums::on(Auth::user()->database_name)->find($id);
        ...
        return view('admin.condominiums.edit',compact('var','vendors','branches'));
   ...
   public function update(Request $request, $id)
   {
    ...
    $vars =  Condominiums::on(Auth::user()->database_name)->find($id);
    ...
    $users = Condominiums::on(Auth::user()->database_name)->findOrFail($id);
    ...
    return redirect('/condominiums')->withSuccess('Actualizacion Exitosa!');
    }
